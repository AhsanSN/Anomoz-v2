...
<html lang="en">
  ...
  <meta name="request-id" content="DEA2:7EB1:2020940:3C578E0:5B19F77E" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="DEA2:7EB1:2020940:3C578E0:5B19F77E" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="UNIVERSE_BANNER,FREE_TRIALS,MARKETPLACE_INSIGHTS,MARKETPLACE_INSIGHTS_CONVERSION_PERCENTAGES">

  <meta name="html-safe-nonce" content="9dfe72e874c35ec93f14d6262b12fc026f31069a">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper  js-chromeless-input-container">
        <input type="text"
          ...
          name="q"
          value=""
          placeholder="Search Anomoz"
          aria-label="Search Anomoz"
          data-unscoped-placeholder="Search Anomoz"
  ...
  <div class="container-lg p-responsive position-relative">
    <div class="d-md-flex flex-items-center gutter-md-spacious">
      <div class="col-md-7 text-center text-md-left ">
        <h1 class="alt-h0 text-white lh-condensed-ultra mb-3">Built for Anonymous Meetups</h1>
        ...
        <div class="mx-auto col-sm-8 col-md-5 hide-sm">
          <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
            <form class="home-hero-signup js-signup-form" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="JTD7dPYsY/dT9JxTgbNqZnVrpIanoKIZtIOi9ISa8e8tllm7TdNEcxmi75k5VHcky7u+a4SZ5BsFWuMjQ0IY6Q==" />              <dl class="form-group mt-0">
...
<input type="hidden" name="timestamp" value="1528428419698" class="form-control" />
<input type="hidden" name="timestamp_secret" value="40911e70a82fc7db832cc56c4a21d75c9bc7e789158aba2d99e9b7aab6937f11" class="form-control" />
...
<div class="container-lg p-responsive py-4 text-center text-md-left">
  <div class="col-md-8 col-lg-7 mx-auto d-md-flex flex-items-center">
    <img src="https://assets-cdn.github.com/images/modules/site/tenyears/10.png" alt="10" class="col-6 col-sm-4 mx-auto width-fit">
    <div class="pl-md-4">
      ...
      <p class="mb-0"><a href="/ten">See some of our favorite&nbsp;moments <svg height="14" class="octicon octicon-chevron-right ml-1 v-align-text-bottom" viewBox="0 0 8 16" version="1.1" width="7" aria-hidden="true"><path fill-rule="evenodd" d="M7.5 8l-5 5L1 11.5 4.75 8 1 4.5 2.5 3l5 5z"/></svg></a></p>
    </div>
  </div>
</div>
<hr>
  ...
  <div class="container-lg p-responsive">
    ...
    <div class="col-md-7 mx-auto clearfix p-4 border rounded-1 pt-5">
      ...
      <div class="overflow-hidden">
        ...
        <p>
          <a href="/pricing">Compare plans<span class="no-wrap"><svg height="16" class="octicon octicon-chevron-right ml-2 v-align-text-bottom" viewBox="0 0 8 16" version="1.1" width="8" aria-hidden="true"><path fill-rule="evenodd" d="M7.5 8l-5 5L1 11.5 4.75 8 1 4.5 2.5 3l5 5z"/></svg></span></a>
        </p>
      </div>
    </div>
...
<div class="py-7 py-md-8 py-lg-9 border-top">
  <div class="container-lg p-responsive text-center">
    ...
    <div class="col-md-8 py-md-6 mx-auto">
      ...
      <p>
        <a href="/marketplace">Browse GitHub <span class="no-wrap">Marketplace<svg height="16" class="octicon octicon-chevron-right ml-2 v-align-text-bottom" viewBox="0 0 8 16" version="1.1" width="8" aria-hidden="true"><path fill-rule="evenodd" d="M7.5 8l-5 5L1 11.5 4.75 8 1 4.5 2.5 3l5 5z"/></svg></span></a>
      </p>
    </div>
  </div>
</div>
...
<div class="py-7 py-md-8 py-lg-9 border-top">
      ...
      <div class="communitystats position-relative">
        <a href="/open-source" class="d-inline-block summarylink">
          <div class="circle d-flex flex-column flex-justify-center text-center p-4 mx-auto mt-6 mb-3 m-md-3 bg-orange box-shadow-extra-large">
            <span class="d-block f0-light text-white lh-condensed-ultra mb-2">85M<sup class="f2-light">*</sup></span>
        ...
        <a href="/personal" class="d-inline-block summarylink">
          <div class="circle d-flex flex-column flex-justify-center text-center p-4 mx-auto mt-6 mb-3 m-md-3 bg-blue box-shadow-extra-large">
            <span class="d-block f0-light text-white lh-condensed-ultra mb-2">28M<sup class="f2-light">*</sup></span>
  ...
  <div class="py-7 py-md-8 py-lg-9 bg-gray-dark">
    ...
    <div class="container-xl p-responsive py-6 mt-lg-6">
      <form class="home-hero-signup js-signup-form" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="zGZG1+S2iwb7NyiaxXyWFkCOUCsRqRTnOXF6T2tRR+3EwOQYX0msgrFhW1B9m4tU/l5KxjKQUuWIqDuYrImu6w==" />        <div class="d-lg-flex flex-wrap flex-lg-nowrap flex-justify-between">
          <dl class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <dd>
              <div src="/signup_check/username" csrf="dwatQcqSsHW/PnO7qyg/Ed+r3Fby+j6/3i7HkO/i9+XiX8YblcdBT+YKJFX8GtyUt2OJ2r8WzEuEHVop7au8eQ==">
          ...
          <dl class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <dd>
              <div src="/signup_check/email" csrf="pDYUHtTpvfiPR6kUvFJ0915bMm/1amaqlmdWITTDoXajsxyI/9DBlbynFasoOn22jptpaaadv26og+VhdlEPrw==">
          ...
          <dl class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <dd>
              <div src="/signup_check/password" csrf="HQrIVyJ0xSK9tyAXyvQRKEE38W5ueU9c9y8ToEw3f1LLKoNj4VI1J25JLrWAkBlU65/ARvMKU7jRHGc3L8iqUg==">
          ...
          <input type="hidden" name="source" class="js-signup-source" value="form-home">
          <input type="text" name="required_field_f1af" id="required_field_f1af" style="display: none" class="form-control" />
<input type="hidden" name="timestamp" value="1528428419707" class="form-control" />
<input type="hidden" name="timestamp_secret" value="034a3f2cf17e200450877cb5e4c504bfcf28239c4add06cac1c2071dafb1f08c" class="form-control" />
